<template>
  <div>
    <el-dialog title="新增低代码授权API" :visible.sync="isShow" width="800px" center v-loading="authLoading">
      <el-form ref="elForm" :model="form" inline>
        ...
        <el-form-item label="我创建的API" prop="createdForSelf">
          <el-checkbox v-model="form.createdForSelf"></el-checkbox>
        </el-form-item>
        <el-form-item>
      ...
      <div style="text-align: right; background-color: white; margin-top: 20px">
        <el-pagination
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      appId() {
        return parseInt(this.$route.query.appId);
      },
    },
    watch: {
      isShow: {
    ...
    methods: {
      ...
      resetFields() {
        ...
        this.form.apiName = '';
        this.form.createdForSelf = false;
        this.page.pageNo = 1;
      ...
      handleSelectionChange(val) {
        ...
        this.addAuthParamsList = val.map(o => o.dataAssetApiId);
      },
      onSizeChange(val) {
      ...
      onSave() {
        ...
        const params = {
          ...
          dataAssetApiId: this.addAuthParamsList,
        };
        dataAccessAppApi
