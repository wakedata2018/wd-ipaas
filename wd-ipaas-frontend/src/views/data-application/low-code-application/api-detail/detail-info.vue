  ...
  <el-scrollbar class="page-scrollbar">
    ...
    <div v-if="infoData.baseInfo" v-loading="loading" class="page-content">
      <div class="page-title">
        ...
        <div v-if="appId" class="relieve-button">
...
<script>
  ...
  import accessApi from '@/api/data-access-app';
      ...
      onRelieve() {
        this.$confirm('是否确定移除该API?', '提示', {
          ...
          const params = {
            ...
            dataAssetApiId: [this.infoData.baseInfo.dataAssetApiId],
          };
          accessApi.batchRevoke(params).then(() => {
