    ...
    <div class="bd-container">
      ...
      <div class="app-table">
        <el-table :data="tableData" v-loading="loading.list" class="dss-table bd-table">
          ...
          <el-table-column prop="inCharge" label="负责人" align="center" width="80">
            <!-- <template slot-scope="scope">
              {{getInChargeName(scope.row.inCharge)}}
            </template> -->
          </el-table-column>
...
<script>
  ...
  export default {
    components: { SmHeader, NewApp, DisplayApp, WhiteIp, SearchCard, Pager },
    ...
    methods: {
      ...
      // 获取负责人列表
      queryInChargeList() {
        daaAPI.queryInChargeList().then(res => {
          if (res.success) {
