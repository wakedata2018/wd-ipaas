<template>
  <div class="theme-select">
    ...
    <div class="theme-list">
      <el-button type="text" class="third-auth-btn" v-if="$route.query.id" @click="onShowDialog">授权API</el-button>
...
<script>
  export default {
    ...
    watch: {
      keyword(val) {
        const arr = this.$plain(this.list);
      ...
      list: {
        ...
        handler(val) {
          this.$nextTick(() => {
            this.filterList = this.$plain(val);
          });
        },
      },
    },
