...
/**
 * @author Eduardo Macarron yiyufeng
 * @title TypeHandlerRegistry
...
public final class TypeHandlerRegistry {
    ...
    public void register(Class<?> typeHandlerClass) {
        boolean mappedTypeFound = false;
        MappedTypes mappedTypes = null;
        try {
            Class<?> clazz = this.getClass().getClassLoader().loadClass(typeHandlerClass.getName());
            Class<MappedTypes> aClass = (Class<MappedTypes>) this.getClass().getClassLoader().loadClass(MappedTypes.class.getName());
            mappedTypes = clazz.getAnnotation(aClass);
        ...
        if (mappedTypes != null) {
            for (String basePackage : mappedTypes.basePackage()) {
                ...
                try {
                    resolverUtil.find(new ResolverUtil.IsA(resolverUtil.getClassLoader().loadClass(BaseDbEnum.class.getName())), basePackage);
                } catch (ClassNotFoundException e) {
                    e.printStackTrace();
                }
